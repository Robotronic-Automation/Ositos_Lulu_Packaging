 ...
 */
bool isEmpty(Buffer_Circ_String * buff)
{
	if(buff->contador == 0)
  {
		return true;
 ...
 */
bool isFull(Buffer_Circ_String * buff)
{
 ...
 */
int8_t get_item(char data[], Buffer_Circ_String * buff )
{
	if(isEmpty(buff))
  {
 ...
 */
int8_t put_item(char data[], Buffer_Circ_String * buff )
{
	if(isFull(buff))
  {
 ...
 */
uint32_t number(Buffer_Circ_String * buff)
{
 ...
 */
int8_t listBuffer(Buffer_Circ_String * buff)
{
	if(isEmpty(buff))
  {
		Serial.printf("Error: No hay datos en el vector\n"); 
